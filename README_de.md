...
4. **Einbettungen, aka Embed-Flows**: Ihr könnt in den Settings die Option
   ...
   - Embed-Flows haben einige Vorteile - der größte ist wohl, dass bei ihnen
     keine Datenduplikation nötig ist. Sie bringen aber auch einige Nachteile
     mit sich. Beides wird im Abschnitt
...
- **Flow im aktiven Leaf exportieren:** Falls du die Menüleiste nicht aktiviert
  hast.
- **Baue den Flow im aktiven Leaf als anderen Typ neu:** So könnt ihr bei Bedarf
  schnell hin und her switchen.
