...
- [Probleme beheben](#9-probleme-beheben) <small>(ich hab keine Ahnung, warum ausgerechnet dieser Link nicht funktioniert)</small>
...
9. [Probleme beheben](#9-probleme-beheben) <small>(ich hab keine Ahnung, warum ausgerechnet dieser Link nicht funktioniert)</small>
