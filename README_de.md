...
**UPDATE:** Seit Version 0.4.0 könnt ihr **[Flows aus Einbettungen](#4-alles-über-embed-flows-einbettungen)** bauen; das bedeutet, diese Flows haben keine Datenduplikation mehr. Ihr müsst dazu nur das Plugin [Sync Embeds von uthvah](https://github.com/uthvah/sync-embeds) installieren und aktivieren (kann derzeit nur manuell installiert werden). 

_Kleine Fixes und einige neue Features mit Bezug auf diese Neuerung kommen über die nächsten Tage. Jedes Release ist aber stabil und kann ohne große Probleme genutzt werden._

_Updates für dieses Readme sind noch nicht vollständig ausgearbeitet._

Gerade baue ich einen Schalter, mit dem man bei Bedarf bequem einen Flow zwischen klassik und embed hin und her schalten kann.
...
Wenn man dazu das Plugin [Sync Embeds von uthvah](https://github.com/uthvah/sync-embeds) installiert, kann man das hier machen: 
```
```sync
![[titel-der-eingebetteten-notiz]]
``` 
...
- **Voraussetzungen:** 
	...
	- Wenn du Embed-Flows nutzen willst, musst du das Plugin [Sync Embeds von uthvah](https://github.com/uthvah/sync-embeds) installieren und aktivieren. ([Mehr dazu](#12-alles-über-embed-flows-einbettungen)
