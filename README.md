...
Here's [a trouble shooting guide](#9-fixing-problems) you can look at before
filing a [bug report](#12-report-a-bug--report-your-love).
...
1. **'Smart' flows:** Define flows from bookmark groups or by using folders,
   ...
   - **Convenient:**
   - All Flows will be automatically checked whenever you move, add, or delete a
     note (or folder) in their source folder, and flagged for rebuild when
...
**Properties aren't perfect:** Sometimes properties or values just aren't being
recognised. I don't know why and I don't know how to fix it.
...
- **Define your flow by...**
  ...
  - **Folders, tags and [properties](#how-to-properties):** You can include or
    exclude. The logic is very basic and only works as well as Dataview. If you
    want an elaborate definition, you'll have to use Bases or Dataview to define
    a query and then tag the results.
