...
7. **Navigate via fuzzy navigation modal:** If you're used to working with Obsidian's Quick switcher modal, you'll be right at home here - with some handy tricks included:
...
- **Redirect for internal links:** (10) An entry in the context menu for internal links that allows you to open the link in a flow instead of the originally addressed note.
- **Bespoke artisanal flows:** (10) The option to input a random file list as flow source. 
- **Favourites for the switcher modal:** (10) In case you have a gazillion flows, need help staying on top of them, and frontmatter/Dataview seem scary to you. 
