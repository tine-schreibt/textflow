...
- **Define your flow by...**
	...
	- **Folders, tags and [properties](#how-to-properties):** You can include or exclude. The logic is very basic and only works as well as Dataview. If you want an elaborate definition, you'll have to use Bases or Dataview to define a query and then tag the results. 
