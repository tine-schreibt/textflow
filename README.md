...
4. **No auto-sync on closing Obsidian:** Onunload, Obsidian gives plugins barely
   ...
   vault again.
5. **textFlow's menu bar sometimes overlaps Editing Toolbar or the search bar or
...
- **Problem:** I bookmarked a folder but when I try to make a flow from that,
  ...
  - **Solution:** You have to bookmark the notes. Before that you can create a
    new bookmarks group with the title of their folder.
